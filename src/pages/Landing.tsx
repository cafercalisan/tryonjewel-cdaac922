                ...
                <div className="relative">
                  ...
                  >
                    <img
                      ...
                      src="/lovable-uploads/d9abf31c-925c-4750-961f-11908e4e649a.webp"
                    />
                  </motion.div>
                  {/* Decorative element */}
                  <motion.div
          ...
          >
            <Link to="/ornekler">
              <Button 
                size="lg" 
                variant="outline" 
                className="rounded-full px-10 py-6 text-base font-medium border-2 border-primary/30 hover:border-primary hover:bg-primary/5 transition-all duration-300 group"
              >
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 md:gap-6 relative">
              ...
              <HowItWorksStep
                number={1}
                title="Ürünü Çek"
                description="Doğru ışıklandırma ve belirgin detaylar ile ürününüzü fotoğraflayın."
              ...
              <HowItWorksStep
                number={2}
                title="Stilini Seç"
                description="Koleksiyonunuza en uygun kampanya temasını belirleyin."
              ...
              <HowItWorksStep
                ...
                description="Yayınlamaya hazır, yüksek çözünürlüklü görselleri indirin."
                      ...
                      <div className="w-full max-w-[280px] space-y-6">
                        ...
                        <div className="flex justify-center gap-4">
                          {[
                            ...
                            { icon: Repeat, color: 'from-green-500 to-green-600' },
                          ].map((item, i) => (
                            <motion.div
                              key={i}
                          ...
                          {Array.from({ length: 21 }).map((_, i) => (
                            <motion.div
                              ...
                              className={`aspect-square rounded-lg ${
                                i % 3 === 0 ? 'bg-primary/60' : i % 2 === 0 ? 'bg-primary/30' : 'bg-muted'
                              }`}
                              initial={{ opacity: 0 }}
              ...
              >
                ...
                <div className="space-y-4 mb-8">
                  ...
                  >
                    ...
                    <p className="text-sm md:text-base">Instagram, Pinterest, Facebook için optimize</p>
                  </motion.div>
                  <motion.div
                    className="flex items-center gap-4 justify-center lg:justify-start"
                    initial={{ opacity: 0, x: -20 }}
        ...
        <div className="container">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {/* Starter Package */}
              <motion.div
                className="relative rounded-3xl border border-border/50 bg-card p-8 hover:border-primary/30 transition-colors"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                viewport={{ once: true }}
              ...
              {/* Pro Package */}
              <motion.div
                className="relative rounded-3xl border-2 border-primary bg-gradient-to-b from-primary/10 to-transparent p-8 shadow-luxury-lg"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
